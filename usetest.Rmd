...
library(tidyverse)
# takes too long
# why do i need to do this below to avoid errors in the gazepath is not clear, but suggest that sopmewhere along the procesign pipelile the daatframe becomes formated weirdly
